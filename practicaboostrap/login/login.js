...
document.addEventListener('DOMContentLoaded', function() {
    ...
    formularioInicioSesion.addEventListener('submit', async function(event) {
        ...
        try {
            const response = await fetch(`http://localhost:8000/api/usuarioOK/?usuario=${correoElectronico}&contrasenia=${contrasena}`, {
                method: 'GET',
                headers: {
            ...
            window.location.href = 'http://127.0.0.1:5501/practicaboostrap/index.html';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    formularioRegistro.addEventListener('submit', async function(event) {
        ...
        try {
            ...
            const response = await fetch('http://localhost:8000/api/usua', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
